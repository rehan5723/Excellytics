...
export default function SignUp() {
  ...
  return (
    <div className="min-h-dvh flex items-center justify-center bg-gray-950 dark:bg-black p-4 relative">
      ...
      >
        ...
        <form className="space-y-5" onSubmit={handleSignUp}>
          ...
          {showSecret && (
            ...
            >
<label htmlFor="secretKey" className="flex items-center gap-2 text-sm font-medium text-gray-300 relative">
  Admin Secret Key
  <span
  ...
  >
    <FiInfo />
    <span
      className={`absolute bottom-full mb-2 left-1/2 -translate-x-1/2 w-max max-w-xs px-3 py-2 text-xs text-white bg-gray-700 rounded-lg shadow-xl transition-opacity duration-300 ${
